...
export const decreaseInventory = async (inventory: increaseInventoryModel) => {
  const response = await petitionWithToken(inventoryUrlApi.decreaseInventory, inventory, 'POST');
