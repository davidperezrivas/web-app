...
function Navbar() {
  ...
  const toggleProfile = (isOpen: boolean) => {
            ...
            <div className="hidden sm:ml-6 sm:block">
              <div className="flex space-x-4">
                ...
                <div className="relative">
                  ...
                  >
                    <Link to="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-300">
                      Option 1 sdfsfsdf Option 1 sdfsfsdf
                    </Link>
                    <Link to="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-300">
                      Option 2sdf sdfsdfsdf
                    </Link>
                    <Link to="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-300">
                      Option 3 sdfsdfsdf
                    </Link>
            ...
            <div className="relative ml-3">
              <div>
                <button
                  ...
                  aria-expanded="false"
                  aria-haspopup="true"
                  onFocus={() => toggleProfile(true)}
                  onBlur={() => toggleProfile(false)}
                >
                  <span className="absolute -inset-1.5"></span>
